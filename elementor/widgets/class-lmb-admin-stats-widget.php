    ...
    protected function render() {
        ...
        <div class="lmb-admin-stats-widget">
            <div class="lmb-stats-grid lmb-stats-grid-admin">
                ...
                <div class="lmb-stat-card lmb-stat-inactive-clients"><div class="lmb-stat-icon"><i class="fas fa-user-clock"></i></div><div class="lmb-stat-content"><div class="lmb-stat-number"><?php echo number_format($stats['inactive_clients']); ?></div><div class="lmb-stat-label">Clients Inactifs</div></div></div>
