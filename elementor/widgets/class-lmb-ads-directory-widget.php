...
class LMB_Ads_Directory_Widget extends Widget_Base {
    ...
    protected function render() {
        ...
        <div class="lmb-directory-container">
                    ...
                    ?>
                        <article class="lmb-ad-card">
                            ...
                            <div class="lmb-ad-actions">
                                <?php if ($pdf_url): ?>
                                    <a href="<?php echo esc_url($pdf_url); ?>" class="lmb-btn" target="_blank"><?php esc_html_e('Download PDF', 'lmb-core'); ?></a>
                                <?php endif; ?>
                            </div>
                        </article>
                    <?php endwhile; ?>
            ...
            <?php else : ?>
                <p><?php esc_html_e('No legal ads found matching your criteria.', 'lmb-core'); ?></p>
            <?php endif;
            wp_reset_postdata();
            ?>
        </div>
