        ...
        <div class="lmb-packages-editor">
            <div class="lmb-editor-form-container">
                <div class="lmb-widget-header">
                    <h3><i class="fas fa-edit"></i> Add / Edit Package</h3>
                </div>
                <form id="lmb-package-form" class="lmb-editor-form">
                    ...
                    <button type="submit" class="lmb-btn lmb-btn-primary"><i class="fas fa-save"></i> Save Package</button>
                    <button type="button" id="lmb-clear-form-btn" class="lmb-btn lmb-btn-secondary" style="margin-top:10px;"><i class="fas fa-undo"></i> New Package</button>
                </form>
            </div>

            <div class="lmb-packages-list-container">
                <div class="lmb-widget-header">
                    <h3><i class="fas fa-list-ul"></i> Existing Packages</h3>
                </div>
                <div id="lmb-packages-list" class="lmb-packages-list">
                    ...
                    if ($packages_query->have_posts()) {
                        ...
                        echo '<p>No packages found. Add one using the form.</p>';
                    }
                    wp_reset_postdata();
                    ?>
                </div>
        ...
        <div class="lmb-package-card" data-package-id="<?php echo $package_id; ?>">
            ...
            <div class="lmb-package-card-body">
                ...
                <div class="lmb-package-card-details">
                    <span><strong>Price:</strong> <?php echo esc_html($price); ?> MAD</span>
                    <span><strong>Points:</strong> <?php echo esc_html($points); ?></span>
                    <span><strong>Cost/Ad:</strong> <?php echo esc_html($cost_per_ad); ?></span>
                </div>
            </div>
        </div>
        <?php
